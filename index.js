...
function getFinals(array) {
    const filteredStage = fifaData.filter((element) => {
...
function getYears(array, callback) {
    return callback(array).map(element => element.Year);
}
...
function getWinners(array, callback) {
    return callback(array).map(element => element['Home Team Goals'] > element['Away Team Goals'] ? element['Home Team Name'] : element['Away Team Name']);
}
...
function getAverageGoals(array) {
    const averageGoals = array.reduce((accumulator, currentValue) => {
